...
class UpdateRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'min_sum'           => 'numeric|min:0',
            'max_sum'           => 'numeric|min:0|gte:min_sum',
    ...
    {
        return [
            'promotion_id.required'      => 'Поле идентификатора акции обязательно для заполнения.',
            'promotion_id.exists'        => 'Указанная акция не существует.',
            ...
            'promotion_type_id.required' => 'Поле типа акции обязательно для заполнения.',
