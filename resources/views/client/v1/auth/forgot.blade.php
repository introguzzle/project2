            ...
            <header id="main-header" class="register-header">
                ...
                <form action="{{route('forgot-password.post')}}" method="POST" class="register-form">
                    ...
                    <div class="form-group form-group-1 form-group-email">
                        ...
                        <input type="email" id="login" name="login" class="form-input" placeholder="Введите почту"
                               required>
                    </div>
                    ...
                    @if (session()->has('fail'))
                        <div class="form-group"
                             style="color: red; font-size: 1.2em; justify-content: center; align-items: center">
